	...
	function markerOnClick(e) {
	   ...
	   if (oldLayer) oldLayer.setStyle({"color": "#000"});
	...
	/////////////////////////////////////////////////////////////////////////////////////////
	// export poly testing
	// document.getElementById('export_poly').onclick = function(e) {
		// // Extract GeoJson from featureGroup
		// var data = polylines.toGeoJSON();
		// // Stringify the GeoJson
		// var convertedData = 'text/json;charset=utf-8,' + encodeURIComponent(
			// JSON.stringify(data));
		// // Create export
		// document.getElementById('export_poly').setAttribute('href', 'data:' +
			// convertedData);
		// document.getElementById('export_poly').setAttribute('download',
			// 'data.geojson');
	// }
